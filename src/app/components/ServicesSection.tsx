            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        custom={0}
                        className="text-3xl md:text-4xl font-black text-[#1a0a2a] mb-4"
                    >
                        Our Services
                    </motion.h2>
                    <motion.p
                ...
                >
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="group p-10 md:p-12 rounded-[2.5rem] bg-white border border-purple-100 shadow-[0_10px_30px_-10px_rgba(168,85,247,0.08)] hover:shadow-[0_20px_40px_-15px_rgba(168,85,247,0.12)] transition-all duration-500 overflow-hidden relative"
                        >
                            ...
                            <div className="relative z-10">
                                <div className={`w-16 h-16 ${service.color} rounded-2xl flex items-center justify-center mb-8 transition-transform duration-500`}>
                                    <service.icon className={service.iconColor} size={36} />
                                </div>
                                <h3 className="text-2xl md:text-3xl font-black text-[#1a0a2a] mb-4 group-hover:text-purple-600 transition-colors duration-500 tracking-tight">
                                    {service.title}
                                </h3>
                                <p className="text-slate-500 leading-relaxed font-semibold text-sm md:text-base max-w-xs">
                                    {service.description}
                                </p>
                            </div>
                        </motion.div>
